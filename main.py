...
def adicionarContato() -> None:
    ...
    limparCampos()
    atualizarTabela()
    messagebox.showinfo("Sucesso!", f"Contato adicionado com sucesso!")
    ...
    # messagebox.showinfo("Enviado", f"Bem vindo, {telefone}")
...
btn_editar = Button(janela, text="Editar", fg="blue",
                       font="Tahoma 12 bold", width=8, command=editarContato)
btn_editar.grid(row=3, column=1)

btn_deletar = Button(janela, text="Deletar", fg="blue",
